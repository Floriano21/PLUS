...
````
bash <(wget -qO- https://raw.githubusercontent.com/Floriano21/senharoot/main/senharoot.sh)
````
...
````
apt update -y && apt upgrade -y && wget -y; bash <(wget -qO- raw.githubusercontent.com/Floriano21/PLUS/main/ssh-plus)
````
